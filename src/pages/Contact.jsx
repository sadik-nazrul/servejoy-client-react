import { FaEnvelope, FaLocationPin, FaMessage, FaPhone } from "react-icons/fa6";
            ...
            <div className="container px-6 py-12 mx-auto">
                ...
                <div className="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-2">
                    <div className="grid grid-cols-1 gap-12 md:grid-cols-2">
                        <div>
                            <span className="inline-block p-3 text-secondary rounded-full bg-blue-100/80 dark:bg-gray-800">
                                <FaEnvelope />
                            </span>

                            <h2 className="mt-4 text-base font-medium text-gray-800 dark:text-white">Email</h2>
                            <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">Our friendly team is here to help.</p>
                            <p className="mt-2 text-sm text-secondary dark:text-blue-400">hello@merakiui.com</p>
                        </div>
                        ...
                        <div>
                            ...
                            <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">Our friendly team is here to help.</p>
                            <p className="mt-2 text-sm text-secondary dark:text-blue-400">Start new chat</p>
                        </div>
                        ...
                        <div>
                            ...
                            <p className="mt-2 text-sm text-secondary dark:text-blue-400">100 Smith Street Collingwood VIC 3066 AU</p>
                        </div>
                        ...
                        <div>
                            ...
                            <p className="mt-2 text-sm text-secondary dark:text-blue-400">+1 (555) 000-0000</p>
                        </div>
                    </div>
                    ...
                    <div className="p-4 py-6 rounded-lg bg-gray-50 dark:bg-gray-800 md:p-8">
                        <form>
                            ...
                            <button className="w-full px-6 py-3 mt-4 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-secondary rounded-lg hover:bg-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-50">
                                Send message
                            </button>
                        </form>
                    </div>
